...
with open("parsed_file/disease.csv", "a") as output:
    output.write(",".join(["ko", "name", "description", "disease_category", "icd10"]) + "\n")

with open("parsed_file/drug.csv", "a") as output:
    output.write(",".join(["ko", "name",]) + "\n")

with open("parsed_file/pathogen_tmp.csv", "a") as output:
    output.write(",".join(["ko", "name"]) + "\n")

with open("parsed_file/gene_tmp.csv", "a") as output:
    output.write(",".join(["ko", "name"]) + "\n")

with open("parsed_file/drug_disease.csv", "a") as output:
    output.write(",".join(["from", "to"]) + "\n")

with open("parsed_file/pathogen_disease_tmp.csv", "a") as output:
    output.write(",".join(["from", "to"]) + "\n")

with open("parsed_file/gene_disease.csv", "a") as output:
...
with open("parsed_file/disease_kegg_id.json", "w") as f:
